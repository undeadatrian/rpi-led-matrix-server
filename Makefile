CXXFLAGS=-Wall -O3 -g
OBJECTS=demo-main.o minimal-example.o text-example.o led-image-viewer.o pixelator-server.o
BINARIES=led-matrix minimal-example text-example pixelator-server
...
pixelator-server : pixelator-server.o $(RGB_LIBRARY)
	$(CXX) $(CXXFLAGS) pixelator-server.o -o $@ $(LDFLAGS)
